...
(c) 2000, 2011 Advanced Distributed Learning (ADL). Some Rights Reserved.
*****************************************************************************
...
**
**    javascript:
**          var result = this.doLMSInitialize();
**          if (result != true)
**          {
**             // handle error
**          }
**
**    authorware:
**          result := ReadURL("javascript:this.doLMSInitialize()", 100)
**
**    director:
**          result = externalEvent("javascript:this.doLMSInitialize()")
**
**
*******************************************************************************/
...
*******************************************************************************/
  LMSApi.doLMSInitialize = function()
    ...
    var result = api.LMSInitialize('').toString();
...
*******************************************************************************/
  LMSApi.doLMSFinish = function()
    ...
    var result = api.LMSFinish('').toString();
    if (result != 'true')
    {
      var err = this.ErrorHandler();
...
*******************************************************************************/
  LMSApi.doLMSGetValue = function(name)
    ...
    else if (! this.doLMSInitialize())
    {
      var err = this.ErrorHandler(); // get why this.doLMSInitialize() returned false
...
*******************************************************************************/
  LMSApi.doLMSSetValue = function(name, value)
    ...
    {
      err = this.ErrorHandler(); // get why this.doLMSInitialize() returned false
...
**
** Usage:
** var last_error = this.ErrorHandler();
