<article id="activity-preview-body">
  ...
  {{#each pages}}
    {{#ifequalhelp flavor "simple"}}
      <section class="widget-box page-simple">
    {{/ifequalhelp}}
    {{#ifequalhelp flavor "quizz"}}
      <section class="widget-box page-quizz">
    {{/ifequalhelp}}
    {{#ifequalhelp flavor "tat"}}
      <section class="widget-box page-tat">
    {{/ifequalhelp}}
