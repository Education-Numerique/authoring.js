    ...
    <aside class="span3 side-menu pull-right">
      ...
      <nav>
        ...
        <ul class="pages-list" id='wtf'>
          {{reset_index}}
          {{#each pages}}
            {{#ifequalhelp flavor.id "simple"}}<li class="page-simple menu-items">{{/ifequalhelp}}
            {{#ifequalhelp flavor.id "quizz"}}<li class="page-quizz menu-items">{{/ifequalhelp}}
            {{#ifequalhelp flavor.id "tat"}}<li class="page-tat menu-items">{{/ifequalhelp}}
            {{#ifequalhelp flavor.id "jmt"}}<li class="page-jmt menu-items">{{/ifequalhelp}}
            {{#ifequalhelp flavor.id "perf"}}<li class="page-perf menu-items">{{/ifequalhelp}}
              <a href="#"><span class='vorg'>{{index}}.</span> {{title}}</a>
            </li>
          {{/each}}
        </ul>
      </nav>
              ...
              <dl>
                ...
                <dd>
                  ...
                  <ul class="qrm">
                    {{reset_index "aid"}}
                    {{#each answers}}
                    <li id="answer-{{index 'aid'}}" style='padding-bottom: 10px; border-bottom: dotted 1px #DDDDDD;'>
                    <form>
                      ...
                      <div class="modal hide" role="dialog" aria-hidden="true">
                        <div class="modal-header">
                          <h3>Pas tout à fait (<span class="feedback"></span>).
                            <br />{{#if comment}}Voici un indice :{{/if}}</h3>
                        </div>
