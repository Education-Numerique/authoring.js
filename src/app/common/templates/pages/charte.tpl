/*
* @template : pages/charte
*/

<div class="row-fluid">
  <div class="alert alert-info">
    <a href="#" data-dismiss="alert" class="close">fermer</a>
  </div>
...
-->
  <section class="widget-content">
        <p align="center"><strong>CHARTE DES AUTEURS </strong><br />
          <strong>CONDITIONS GENERALES D’UTILISATION</strong></p>
    ...
    <ol syle="text-align: justify;">
      <li><strong>Généralités</strong>
        ...
        <p>Pour plus d’informations sur les questions de propriété intellectuelle, rendez-vous sur les FAQ du site de l’association&nbsp; <a href="http://www.education-et-numerique.org/faq-2/" target="_blank">http://www.education-et-numerique.org/faq-2/</a><br />
          Pour la conformité de nos activités avec les exigences de la CNIL <a  {{action showCnil href=true}}>cliquez ici</a>.</p>
    </ol>
  </section>
</article>
