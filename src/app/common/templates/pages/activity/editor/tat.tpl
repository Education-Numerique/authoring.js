...
<div class="container-fluid">
        ...
        <div class="widget-content slidify-on" id="page-informations">
            ...
            <div class="control-group">
                <div class="input-prepend">
                    ...
                    {{view LxxlLib.Em.TextField valueBinding="currentPage.title" focus="true" classNames="span2" id="form-page-title" placeholder="Texte à trous"}}
                </div>
                <!--
                <div class="input-prepend">
    ...
    <div class="widget-box">
        ...
        <div class="widget-content slidify-on nopadding" id="page-tat">
                {{view LxxlLib.Em.Wysiwyg valueBinding="currentPage.tat" plugins="mathjax,tat,tooltip,imagemanager" classNames="redactorjs"}}
        </div>
    </div>
